...
describe "納音" do
  ...
  describe "五行" do
    ...
    test_patterns = [{:key => 'kane', :chishi => 'ne', :tenkan => 'kinoe'},
                     ...
                     {:key => 'kane', :chishi => 'saru', :tenkan => 'mizunoe'},
                     {:key => 'kane', :chishi => 'tori', :tenkan => 'mizunoto'},
                     {:key => 'hi', :chishi => 'inu', :tenkan => 'kinoe'},
                     {:key => 'hi', :chishi => 'i', :tenkan => 'kinoto'},
                     {:key => 'mizu', :chishi => 'ne', :tenkan => 'hinoe'},
                     {:key => 'mizu', :chishi => 'usi', :tenkan => 'hinoto'},
                     {:key => 'tsuchi', :chishi => 'tora', :tenkan => 'tsuchinoe'},
                     {:key => 'tsuchi', :chishi => 'u', :tenkan => 'tsuchinoto'},
                     {:key => 'kane', :chishi => 'tatsu', :tenkan => 'kanoe'},
                     {:key => 'kane', :chishi => 'mi', :tenkan => 'kanoto'},
                     {:key => 'ki', :chishi => 'uma', :tenkan => 'mizunoe'},
                     {:key => 'ki', :chishi => 'hitsuji', :tenkan => 'mizunoto'},
                     {:key => 'mizu', :chishi => 'saru', :tenkan => 'kinoe'},
                     {:key => 'mizu', :chishi => 'tori', :tenkan => 'kinoto'},
                     {:key => 'tsuchi', :chishi => 'inu', :tenkan => 'hinoe'},
                     {:key => 'tsuchi', :chishi => 'i', :tenkan => 'hinoto'},
                     {:key => 'hi', :chishi => 'ne', :tenkan => 'tsuchinoe'},
                     {:key => 'hi', :chishi => 'usi', :tenkan => 'tsuchinoto'},
                     {:key => 'ki', :chishi => 'tora', :tenkan => 'kanoe'},
                     {:key => 'ki', :chishi => 'u', :tenkan => 'kanoto'},
                     {:key => 'mizu', :chishi => 'tatsu', :tenkan => 'mizunoe'},
                     {:key => 'mizu', :chishi => 'mi', :tenkan => 'mizunoto'},
                     {:key => 'kane', :chishi => 'uma', :tenkan => 'kinoe'},
                     {:key => 'kane', :chishi => 'hitsuji', :tenkan => 'kinoto'},
                     {:key => 'hi', :chishi => 'saru', :tenkan => 'hinoe'},
                     {:key => 'hi', :chishi => 'tori', :tenkan => 'hinoto'},
                     {:key => 'ki', :chishi => 'inu', :tenkan => 'tsuchinoe'},
                     {:key => 'ki', :chishi => 'i', :tenkan => 'tsuchinoto'},
                     {:key => 'tsuchi', :chishi => 'ne', :tenkan => 'kanoe'},
                     {:key => 'tsuchi', :chishi => 'usi', :tenkan => 'kanoto'},
                     {:key => 'kane', :chishi => 'tora', :tenkan => 'mizunoe'},
                     {:key => 'kane', :chishi => 'u', :tenkan => 'mizunoto'},
                     {:key => 'hi', :chishi => 'tatsu', :tenkan => 'kinoe'},
                     {:key => 'hi', :chishi => 'mi', :tenkan => 'kinoto'},
                     {:key => 'mizu', :chishi => 'uma', :tenkan => 'hinoe'},
                     {:key => 'mizu', :chishi => 'hitsuji', :tenkan => 'hinoto'},
                     {:key => 'tsuchi', :chishi => 'saru', :tenkan => 'tsuchinoe'},
                     {:key => 'tsuchi', :chishi => 'tori', :tenkan => 'tsuchinoto'},
                     {:key => 'kane', :chishi => 'inu', :tenkan => 'kanoe'},
                     {:key => 'kane', :chishi => 'i', :tenkan => 'kanoto'},
                     {:key => 'ki', :chishi => 'ne', :tenkan => 'mizunoe'},
                     {:key => 'ki', :chishi => 'usi', :tenkan => 'mizunoto'},
                     {:key => 'mizu', :chishi => 'tora', :tenkan => 'kinoe'},
                     {:key => 'mizu', :chishi => 'u', :tenkan => 'kinoto'},
                     {:key => 'tsuchi', :chishi => 'tatsu', :tenkan => 'hinoe'},
                     {:key => 'tsuchi', :chishi => 'mi', :tenkan => 'hinoto'},
                     {:key => 'hi', :chishi => 'uma', :tenkan => 'tsuchinoe'},
                     {:key => 'hi', :chishi => 'hitsuji', :tenkan => 'tsuchinoto'},
                     {:key => 'ki', :chishi => 'saru', :tenkan => 'kanoe'},
                     {:key => 'ki', :chishi => 'tori', :tenkan => 'kanoto'},
                     {:key => 'mizu', :chishi => 'inu', :tenkan => 'mizunoe'},
