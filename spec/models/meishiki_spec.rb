...
describe MeishikiPlr, "9" do
  ...
  describe "年柱" do
    ...
    it "蔵干" do
      meishiki.year_pillar.zoukan.name.should == "辛"
    end
  end
  ...
  describe "月柱" do
    ...
    it "蔵干" do
      meishiki.month_pillar.zoukan.name.should == "甲"
    end
  end

  describe "日柱" do
    it "天干" do
      meishiki.day_pillar.tenkan.name.should == "戊"
    end
    it "地支" do
      meishiki.day_pillar.chishi.name.should == "戌"
    end
    it "蔵干" do
      meishiki.day_pillar.zoukan.name.should == "辛"
    end
  end

  describe "時柱" do
    it "天干" do
      meishiki.time_pillar.tenkan.name.should == "庚"
    end
    it "地支" do
      meishiki.time_pillar.chishi.name.should == "申"
    end
    it "蔵干" do
      meishiki.time_pillar.zoukan.name.should == "壬"
    end
  end
end
...
describe MeishikiPlr, "10" do
  ...
  describe "年柱" do
    ...
    it "蔵干" do
      meishiki.year_pillar.zoukan.name.should == "丁"
    end
  end
  ...
  describe "日柱" do
    it "天干" do
      meishiki.day_pillar.tenkan.name.should == "己"
    end
    it "地支" do
      meishiki.day_pillar.chishi.name.should == "亥"
    end
    it "蔵干" do
      meishiki.day_pillar.zoukan.name.should == "甲"
    end
  end

  describe "時柱" do
    it "天干" do
      meishiki.time_pillar.tenkan.name.should == "壬"
    end
    it "地支" do
      meishiki.time_pillar.chishi.name.should == "申"
    end
...
describe MeishikiPlr, "12" do
  ...
  describe "日柱" do
    ...
    it "地支" do
      meishiki.day_pillar.chishi.name.should == "丑"
    end
    it "蔵干" do
      meishiki.day_pillar.zoukan.name.should == "辛"
    end
...
describe MeishikiPlr, "13" do
  ...
  describe "日柱" do
    it "天干" do
      meishiki.day_pillar.tenkan.name.should == "壬"
    end
    it "地支" do
      meishiki.day_pillar.chishi.name.should == "寅"
    end
    it "蔵干" do
      meishiki.day_pillar.zoukan.name.should == "丙"
    end
  end

  describe "時柱" do
    it "天干" do
      meishiki.time_pillar.tenkan.name.should == "戊"
    end
    it "地支" do
      meishiki.time_pillar.chishi.name.should == "申"
    end
